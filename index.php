                     ...
                     <form action='https://crm.zoho.com/crm/WebToLeadForm' id="WebToLeads4415315000004067049" name=WebToLeads4415315000004067049 method='POST' onSubmit='javascript:document.charset="UTF-8"; ' accept-charset='UTF-8'>
                        ...
                        <div id="formSec" class="wrapper margin-top-30">
                           <div class="row">
                              ...
                              <div class="col-sm-12">
                                 <div class="form-group">
                                    <input id="name" type='text' class="form-control name" name='Last Name' placeholder="Full Name:" />
                                 </div>
                              </div>
                              <div class="col-sm-12">
                                 <div class="form-group">
                              ...
                              <div class="col-sm-12">
                                 <div class="form-group">
                                    <input type='text' id="mobile" class="form-control phone" name='Mobile' id="Mobile" placeholder="Phone Number:" />
                                 </div>
                              </div>
                              <div class="col-sm-12">
                                 <div class="form-group">
                                    <input type='text' id="city" class="form-control city" name='city' id="city" placeholder="City:" />
                                 </div>
                              </div>
                             ...
                             <input type="hidden" value="Submit">
                              ...
                              <div class="col-sm-12">
                                 <div class="form-group">
                                    ...
                                    <button onclick="checkMandatory4415315000004067049()" id='formsubmit' type='submit' value='' class="btn btn-cta"  >Submit</button> 
                                 </div>
                              </div>
                           </div>
                        </div>
...
f.src = 'https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15551.230172991312!2d77.7633433!3d12.9841581!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0xe6a017252bbbc88e!2sARK%20Cloud%20City!5e0!3m2!1sen!2sin!4v1589257342631!5m2!1sen!2sin';
